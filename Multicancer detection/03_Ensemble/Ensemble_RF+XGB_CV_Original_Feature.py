...
class RandomForestModel:
    def __init__(self, config, logger=None):
        ...
        # Use original features without interaction engineering
...
class AdvancedFeatureInteractions:
    """Feature Interaction Processing Class - Simplified version (original features only)"""
...
def main():
    ...
    # Full configuration
    config = {
        'output_path': os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'Results', 'Multicancer detection', '03_Ensemble', 'CV', 'Orginal_Feature'),  # Directory path for saving output results
    ...
    try:
        ...
        print("=" * 80)
        print("Genetic Algorithm Enhanced Ensemble Model - Original Features (No Feature Interactions)")
        print("=" * 80)
